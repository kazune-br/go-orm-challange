...
var (
	userAllColumns            = []string{"id", "uid", "created_at", "updated_at"}
...
func (o *User) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("dao: no User provided for reload")
	}
...
func (o *UserSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("dao: empty UserSlice provided for reload all")
	}
